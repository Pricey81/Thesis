...
//#define DAC_SSI_BASE            SSI1_BASE                // DAC
//#define DAC_SSI_SYSCTL_PERIPH   SYSCTL_PERIPH_SSI1       // DAC
...
// GPIO for SSI pins for DAC
//#define DAC_GPIO_PORT_BASE      GPIO_PORTF_BASE
//#define DAC_GPIO_SYSCTL_PERIPH  SYSCTL_PERIPH_GPIOF
//#define DAC_SSI_CLK             GPIO_PIN_2
//#define DAC_SSI_TX              GPIO_PIN_1
//#define DAC_SSI_RX              GPIO_PIN_4
//#define DAC_SSI_FSS             GPIO_PIN_3
//#define DAC_SSI_PINS            (DAC_SSI_TX | DAC_SSI_CLK |      \
                                 DAC_SSI_FSS)
...
void SELECT (void)
{
 ...
 //   ROM_GPIOPinWrite(DAC_GPIO_PORT_BASE, DAC_SSI_FSS, 0); // SET DAC CS TO LOW
}
...
//    ROM_GPIOPinWrite(DAC_GPIO_PORT_BASE, DAC_SSI_FSS, DAC_SSI_FSS);  // DAC DESELECT
...
void xmit_spi(BYTE dat)
{
    ...
    //ROM_SSIDataPut(DAC_SSI_BASE,  ); // DAC TRANSMISSION


}
//static
//void xmit_spiDAC(unsigned short first, unsigned short data) {
 ...
 //   unsigned short dacValue = (first << 12 | (data & 0x0FFF));

 //   SSIDataPut(DAC_SSI_BASE, dacValue); /* Write the DAC data to the tx fifo */


   //GPIOPinWrite(GPIO_PORTE_BASE, GPIO_PIN_5, GPIO_PIN_5);
   //GPIOPinWrite(GPIO_PORT_BASE, GPIO_PIN_5, 0);
...
void send_initial_clock_train(void)
{
  ...
  //  ROM_GPIOPinTypeGPIOOutput(DAC_GPIO_PORT_BASE, DAC_SSI_TX);
 //   ROM_GPIOPinWrite(DAC_GPIO_PORT_BASE, DAC_SSI_TX, DAC_SSI_TX);
   ...
   //     ROM_SSIDataPut(DAC_SSI_BASE, 0xFF);
        /* Flush data read during data write. */
        ROM_SSIDataGet(SDC_SSI_BASE, &dat);
    //    ROM_SSIDataGet(DAC_SSI_BASE, &dacValue);


        //ROM_SSIDataGet(DAC_SSI_BASE, 0xFFFF);  //  DAC WRITE
...
//    ROM_GPIOPinTypeSSI(DAC_GPIO_PORT_BASE, DAC_SSI_TX);
}
...
void power_on (void)
{
    ...
    /* Enable the peripherals used to drive the DAC on SSI */
    //    ROM_SysCtlPeripheralEnable(DAC_SSI_SYSCTL_PERIPH);
   //     ROM_SysCtlPeripheralEnable(DAC_GPIO_SYSCTL_PERIPH);
  ...
  //  ROM_GPIOPinTypeSSI(DAC_GPIO_PORT_BASE, DAC_SSI_TX | DAC_SSI_CLK);  // DAC
 //   ROM_GPIOPinTypeGPIOOutput(DAC_GPIO_PORT_BASE, DAC_SSI_FSS); // DAC
   ...
   //     ROM_SSIConfigSetExpClk(DAC_SSI_BASE, ROM_SysCtlClockGet(),
          //                     SSI_FRF_MOTO_MODE_0, SSI_MODE_MASTER, 400000, 8);
    //    ROM_SSIEnable(DAC_SSI_BASE);
